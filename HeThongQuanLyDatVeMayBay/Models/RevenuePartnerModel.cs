...
{
    public class RevenuePartnerModel
    {
        ...
        public void TinhDoanhThupartner(string ThangTK, string NamTK)
        {
            int sohd = 0;
            int sum = 0;
            ...
            {
                if (ThangTK == dv.NgayDatVe.Value.Month.ToString() && NamTK == dv.NgayDatVe.Value.Year.ToString() && dv.VEMAYBAY.CHUYENBAY.MAYBAY.HANGMAYBAY.TenHang == Content.TenHang)
                {
                    sohd++;
                    var giaend = "";
            ...
            {
                if (ThangTK == dvno.NgayDat2.Value.Month.ToString() && NamTK == dvno.NgayDat2.Value.Year.ToString() && dvno.VEMAYBAY.CHUYENBAY.MAYBAY.HANGMAYBAY.TenHang == Content.TenHang)
                {
                    sohd++;
                    var giaend2 = "";
